      ...
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900">
          <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-semibold">Daftar Bus</h2>
                      ...
                      @foreach ($buses as $bus)
                        <tr>
                          ...
                          <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ route('buses.edit', $bus) }}" class="text-blue-600 hover:text-blue-900">Edit</a>
                            <form action="{{ route('buses.destroy', $bus) }}" method="POST" class="inline-block ml-2">
                              @csrf
                              @method('DELETE')
  ...
  @push('scripts')
    <script>
      ...
      document.addEventListener('DOMContentLoaded', function() {
        const dataTable = new HSDataTable('#busTable');
