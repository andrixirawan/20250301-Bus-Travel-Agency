    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900">
          <h2 class="text-2xl font-semibold mb-6">Tambah Rute Baru</h2>
            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input type="number" id="distance" name="distance" value="{{ old('distance') }}" min="1"
                ...
                <div>
                  ...
                  <input type="number" id="price" name="price" value="{{ old('price') }}" min="1000"
